...
# In v3.0.9+, SignalChannel uses PipeChannel internally (lock-free)
const TEE_USE_PIPECHANNEL = @isdefined(PACKAGE_VERSION) ? PACKAGE_VERSION > v"3.0.9" : true
...
# For v3.0.9+: Uses PipeChannel{Int} for lock-free operation
